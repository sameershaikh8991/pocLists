...
import com.orchestrator.dto.InventoryRequestDTO;
import com.orchestrator.dto.OrchestratorRequestDTO;
import com.orchestrator.dto.OrchestratorResponseDTO;
import com.orchestrator.dto.PaymentRequestDTO;
import com.orchestrator.service.steps.InventoryStep;
import com.orchestrator.service.steps.PaymentStep;
...
public class OrchestratorService {
    ...
    private Workflow getOrderWorkflow(OrchestratorRequestDTO requestDTO){
        WorkflowStep paymentStep = new PaymentStep(this.paymentClient, getPaymentRequestDTO(requestDTO));
